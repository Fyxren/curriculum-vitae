...
type Inlang = {
	projects_fyxren_desc: () => string;
	projects_eseven_desc: () => string;
	projects_mcdata_desc: () => string;
	projects_pianissimo_desc: () => string;
	projects_pianissimo_imgur: () => string;
};

export function getProjects(m: Inlang) {
	return [
		{
			title: 'fyxren.com',
